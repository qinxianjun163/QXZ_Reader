...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        // 初始化文字
//        [self setTitle:MJRefreshFooterStateRefreshingText forState:MJRefreshFooterStateIdle];
        [self setTitle:MJRefreshFooterStateIdleText forState:MJRefreshFooterStateRefreshing];
